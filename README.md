...
--------
To clone the Dedalus_Web_Theme repository, use git clone:

<pre>
 git clone https://github.com/wavemaker/Dedalus_Web_Theme.git
 cd Dedalus_Web_Theme
 npm install
</pre>
...
Build
--------
To build the WaveMaker Theme run the below command from Dedalus_Web_Theme directory
